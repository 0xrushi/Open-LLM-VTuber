...
class CharacterConfig(I18nMixin):
    ...
    wakeword_config: WakewordConfig = Field(
        default_factory=WakewordConfig, alias="wakeword_config"
    )
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        ...
        "wakeword_config": Description(
            en="Configuration for Wakeword Detection", zh="唤醒词检测配置"
        ),
